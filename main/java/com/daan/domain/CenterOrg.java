...
/**
 * @ClassName: CtrOrgs 
 * @Description: TODO([中心机构单位表] — 存储实验室及机构相关的信息，包括名称、电话、报告抬头等内容) 
 * @author zhangliping
 * @date 2015年12月7日 上午10:41:03
 */
@LogModule(moduleName = Constant.MODULE_CENTERORG, entityName = Constant.ENTITY_CENTERORG,moduleId = Constant.MODULEID_CENTERORG)
public class CenterOrg implements Serializable, Cloneable {
	...
	@Log(name = "卫生机构代码", order = 3, dynamicField = {"getOrgTypeId", "1","3"})
	...
	@Log(name = "网站名称（地址）", order = 10, dynamicField = {"getOrgTypeId", "2","3"})
	...
	@Log(name="所属地区", order = 2,dynamicField = {"getOrgTypeId", "3"})
	...
	public String getRegionSId() {
		return this.regionId == null ? "" : this.regionId.toString();
	}
	
	@Override
	public Object clone() throws CloneNotSupportedException {
		CenterOrg centerOrg = (CenterOrg) super.clone();
		return centerOrg;
	}
