...
/**
 * 
* @ClassName: AddDictLogger 
* @Description: TODO(新增操作添加日志信息) 
* @author zengxiaowang
* @date 2015年11月24日 下午9:16:32 
*
 */
public class AddDictLogger extends DictLoggerBase {
	...
	* @throws
	...
	public String getDictContent(ClassMetaData meta) throws SelfDefineException {
		...
		if (clazz == null || this.getToObj() == null) {
		...
		if (StringUtils.isNotEmpty(id)) {
			sb.append("新增记录号为 [" + id + "] 的 " + (StringUtils.isEmpty(meta.getEntityName()) ? meta.getModuleName() : meta.getEntityName()) + " ;  ");
		} else {
			sb.append("新增：" + (StringUtils.isEmpty(meta.getEntityName()) ? meta.getModuleName() : meta.getEntityName()) + " ;  ");
		}*/
