        ...
        <div class="flex-container flex-space-between">
            <div class="search flex-container  flex-space-between">
                <div class="form-control-icon icon-right">
                    <input type="text" id="${cl}SearchStr" class="form-control searchWidth" style="width:250px;" placeholder="搜索内容..."/>
                ...
                <div class="drop-down">
                    <div class="drop-down-selected">
                        <span class="selected-items" id="${cl}StatusSpan">所有</span><i class="fa fa-angle-down "></i>
                    </div>
            ...
            <div class="option icon-group-inline ">
                ...
                <span id="${cl}Add"><i class="icon icon-plus-square"></i>添加</span>
                <span id="${cl}DeleteBatch"><i class="icon icon-trash"></i>删除选中</span>
            </div>
        </div>
    </div>

    <div class="main-content-body">
        <table id="${cl}List"></table>
    </div>
