				...
				<table>
					<tr>
						...
						<th style="width: 15%">英文名称</th>
					 	<th style="display:none">WHONET编码</th> 
					...
					<c:forEach items="${resultList}" var="dictCode" varStatus="status">
						<tr id="tr_${dictCode.id}">
							...
							<td><a href="javascript:showInfo('${dictCode.id}','view');" class="sc" title="${dictCode.codeNo}"><c:out value="${dictCode.codeNo}" escapeXml="true"/></a></td>
							...
							<td class="as">
								...
								<a href="javascript:deleteDictCode('${dictCode.id}');">删除</a></td>
