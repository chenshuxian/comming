...
<head>
  ...
  <link href="${ctx}/css/css1.css" rel="stylesheet"/>
  <link href="${ctx}/css/icon1.css" rel="stylesheet">
  <link href="${ctx}/css/font-awesome1.min.css" rel="stylesheet"/>
  <link href="${ctx}/css/easyui1.css" rel="stylesheet"/>
  ...
  <script src="${ctx}/js/common1.js?v=1.0.0.27"></script>
