...
<script src="${ctx}/js/xuan4.js?var=1.0.0.0"></script>
<title>项目信息列表</title>
</head>
<body>
    <table id="unContainListTable">
		...
		<c:forEach items="${unContainList}" var="item" varStatus="status">
			<tr id="tr_${item.id}">
				<td class="cen4"><a id="checkItem_unContain" value="${item.id}" href="javascript:void(0)" class="not"></a></td>
