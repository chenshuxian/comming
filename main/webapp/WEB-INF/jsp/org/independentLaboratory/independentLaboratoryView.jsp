...
<body class="bg">
    ...
    <form id="editForm" name="editForm">
		...
		<div>
			<span><i>*</i>所属地区</span><input type="text" id="regionId" name="regionId" maxlength="30" value="<c:out value='${entity.regionName}' escapeXml='true'/>" disabled/>
		...
		<div>
		  ...
		  <span><i>*</i>网站名称（地址）</span><input type="text" id="webUrl" name="webUrl" maxlength="55" value="<c:out value='${entity.webUrl}' escapeXml='true'/>" disabled/>
		</div>
		<div>
		    ...
		    <span><i>*</i>联系电话</span><input type="text" id="telephone" name="telephone" maxlength="50" value="<c:out value='${entity.telephone}' escapeXml='true'/>" disabled/>
		</div>
		<div>
