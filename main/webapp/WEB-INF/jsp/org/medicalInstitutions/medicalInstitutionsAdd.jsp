...
<body class="bg">
    ...
    <form id="addForm" name="addForm">
		...
		<div>
			...
			<span>卫生机构代码</span><input onblur="checkSpecialSymbol('nacaoId',<%=RE_SSYMBOL%>,'<%=MSG_SSYMBOL%>','<%=COMFIRM_ID%>','<%=CANCEL_ID%>')" type="text" id="nacaoId" name="nacaoId" maxlength="32" />
		</div>
		<div>
		...
		<div>
		     <span>联系人</span><input onblur="checkSpecialSymbol('contacts',<%=RE_SSYMBOL%>,'<%=MSG_SSYMBOL%>','<%=COMFIRM_ID%>','<%=CANCEL_ID%>')" type="text" id="contacts" name="contacts" maxlength="30" />
		      <span>联系电话</span><input onblur="checkSpecialSymbol('telephone',<%=RE_SSYMBOL%>,'<%=MSG_SSYMBOL%>','<%=COMFIRM_ID%>','<%=CANCEL_ID%>')" type="text" id="telephone" name="telephone" maxlength="50" />
		</div>
		<div>
		     <span>传真号码</span><input onblur="checkSpecialSymbol('fax',<%=RE_SSYMBOL%>,'<%=MSG_SSYMBOL%>','<%=COMFIRM_ID%>','<%=CANCEL_ID%>')" type="text" id="fax" name="fax" maxlength="25" />
		      <span>助记符</span><input onblur="checkSpecialSymbol('fastCode',<%=RE_SSYMBOL%>,'<%=MSG_SSYMBOL%>','<%=COMFIRM_ID%>','<%=CANCEL_ID%>')" type="text" id="fastCode" name="fastCode" maxlength="9" />
		</div>
		<div>
