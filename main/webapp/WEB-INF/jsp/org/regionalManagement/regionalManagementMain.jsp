            ...
            <div class="flex-container flex-space-between">
                <div class="search flex-container  flex-space-between">
                    <div class="form-control-icon icon-right">
                        <input type="text" id="${rmm}SearchStr" class="form-control" placeholder="搜索内容..."/>
                    ...
                    <div class="drop-down">
                        <div class="drop-down-selected">
                            <span class="selected-items" id="${rmm}StatusSpan">所有</span><i class="icon icon-angle-down"></i>
                        </div>
