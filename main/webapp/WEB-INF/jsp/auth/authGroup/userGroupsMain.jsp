...
<div class="flex-container layout-vertical main-content-container" id="${rm}mainContentContainer">
		...
		<div class="flex-container flex-space-between">
			<div class="search flex-container  flex-space-between">
				<div class="form-control-icon icon-right">
					...
					<button class="control-icon text-center" onclick="userGroupsMain.search()">
				...
				<div class="drop-down">
					<div class="drop-down-selected">
						<span class="selected-items" id="${rm}statusSel">全部</span> 
						<i class="icon icon-angle-down"></i>
					</div>
					<div class="drop-down-menu">
						<ul class="list-unstyled ${rm}j_status" id="${rm}j_status">
			...
			<div class="option icon-group-inline ">
				<div class="drop-down drop-down-icon">
					<div class="drop-down-selected">
						<i class="icon icon-sort"></i> <span class="selected-items" id="${rm}sortSel">按顺序号升序</span>
					</div>
					<div class="drop-down-menu">
						<ul class="list-unstyled ${rm}j_sort" id="${rm}j_sort">
	...
	<div class="main-content-body">
		<table id="${rm}roleManagerList"></table>
	</div>
	<!--自定义分页-->
</div>
