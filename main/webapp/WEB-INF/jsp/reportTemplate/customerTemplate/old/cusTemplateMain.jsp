    ...
    <div class="flex-container flex-space-between">
      <div class="search flex-container  flex-space-between">
        ...
        <div class="J_ShowPop J_mechanismList md-size">
          <span class="selected-items" id="${cst}SelectOrg" >请选择机构</span><i class="fa fa-angle-down "></i>
        </div>
        <span class="symbol"></span> <span>所属系统:</span>
        <div class="drop-down">
          <div class="drop-down-selected">
            <span class="selected-items" id="${cst}SystemSpan"></span><i class="fa fa-angle-down "></i>
          </div>
      ...
      <div class="search flex-container  flex-space-between">
        ...
        <div class="drop-down">
          <div class="drop-down-selected">
            <span class="selected-items" id="${cst}Template">全部</span><i class="fa fa-angle-down "></i>
          </div>
          <div class="drop-down-menu">
