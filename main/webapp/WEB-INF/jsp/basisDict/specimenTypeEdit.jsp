...
<%--<body class="bg">--%>
	...
	<%--<form id="editForm" name="editForm">--%>
		...
		<%--<div>--%>
			<%--<span>WHONET编码</span>--%>
			<%--<input type="text" id="whonetCode" name="whonetCode" maxlength="9" value="${entity.whonetCode}" style = "width:70%;" onblur="checkSpecialSymbol('whonetCode',<%=RE_SSYMBOL%>,'<%=MSG_SSYMBOL%>','<%=COMFIRM_ID%>','<%=CANCEL_ID%>')" /> --%>
		<%--</div>--%>
		<%--<div>--%>
			<%--<span>助记符</span>--%>
		...
		<%--<div>--%>
			<%--<span>备注</span>--%>
			<%--<input type="text" id="memo" name="memo" maxlength="150" value="${entity.memo}" style = "width:70%;" onblur="checkSpecialSymbol('memo',<%=RE_SSYMBOL%>,'<%=MSG_SSYMBOL%>','<%=COMFIRM_ID%>','<%=CANCEL_ID%>')" /> --%>
		<%--</div>--%>
        <%--<div class="btns">--%>
