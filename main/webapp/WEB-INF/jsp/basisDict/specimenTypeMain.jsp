        ...
        <div class="flex-container flex-space-between">
            ...
            <div class="option icon-group-inline ">
                <div class="drop-down drop-down-icon">
                    <div class="drop-down-selected">
                        <i class="icon icon-sort"></i><span class="selected-items" id="${sy}SortSpan">排序</span>
                    </div>
                    <div class="drop-down-menu">
                        <ul class="list-unstyled ${sy}-sort-selector">
                ...
                <span id="${sy}Add"><i class="icon icon-plus-square"></i>添加</span>
                <span id="${sy}DeleteBatch"><i class="icon icon-trash"></i>删除选中</span>
            </div>
        </div>
    </div>

    <div class="main-content-body">
        <table id="${sy}List"></table>
    </div>

    <input type="hidden" id="${sy}TypeKey" name="typeKey" value="${typeKey}"/>
    <input type="hidden" id="${sy}Status"/>
    <input type="hidden" id="${sy}Sort"/>
    <input type="hidden" id="specimenTypeMainPreId" value="${sy}">
