		...
		<div class="flex-container flex-space-between">
			<div class="search flex-container  flex-space-between">
				<div class="form-control-icon icon-right">
					<input type="text" class="form-control searchWidth" id="${pc}SearchStr" style="width:250px;" placeholder="搜索内容..."/>
				...
				<div class="drop-down">
					<div class="drop-down-selected">
						<span class="selected-items" id="${pc}StatusSpan">所有</span> <i class="fa fa-angle-down "></i>
					</div>
